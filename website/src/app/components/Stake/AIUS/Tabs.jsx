...
function Tabs({
  ...
  return (
    <>
      <div className='m-[auto] md:w-mobile-section-width md:max-w-center-width lg:w-section-width'>
        <div className='flex justify-start'>
          <div className='all-stake stake-items flex w-full justify-between font-[600] lg:w-[30%]'>
            {tabs.map(function (item, index) {
              return (
                <div
                  className={` ${selectedtab === item ? 'selected mobile-selected-background md:bg-none' : 'non-selected'} md:hover:text-purple-text`}
                  onClick={() => {
                    setSelectedTab(item);
                  }}
                  key={index}
