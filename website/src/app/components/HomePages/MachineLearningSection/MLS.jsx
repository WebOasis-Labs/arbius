              ...
              <div className="flex items-center mt-[30px] gap-[20px]">
                <Link href={"https://arbius.ai/generate"} target="_blank">
                  <div>
                    <button
                      type="button"
                      className="relative group bg-black-background py-2 px-5 lg:px-8 rounded-full flex items-center gap-3 "
                    >
                ...
                <Link href={"https://arbius.ai/paper.pdf"} target="_blank">
                  <div>
                    <button
                      type="button"
                      className="hover:text-[white] hover:border-[transparent] text-original-black border-[1px] border-original-black relative group bg-transparent py-2 px-5 lg:px-8 rounded-full flex items-center gap-3"
                    >
