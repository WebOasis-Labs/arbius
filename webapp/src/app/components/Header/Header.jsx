        ...
        <div className="bg-[white]">
            <div className="flex justify-between h-[80px] w-[90%] m-auto">
                    ...
                    <div className="links-parent mt-[30px] text-[24px] text-[original-black] w-[100%] m-[auto] flex-col items-start flex justify-between lg:w-[auto] lg:flex-row lg:items-center gap-[30px] link-block lg:m-[auto] lg:text-[14px] lg:text-[gray]">
                        ...
                        <div className="link-with-image relative group w-[auto]">
                            <div className="link" onClick={()=>setStakingOpen(!stakingOpen)}>Staking
                                ...
                                <Image className="mobile-height ext-link block lg:hidden" src={down_arrow} alt="" />
                            </div>
                        ...
                        <div className="relative group link-with-image">
                            <div onClick={()=>setModelsOpen(!modelsOpen)}>Models<Image className="mobile-height inline ext-link block lg:hidden" src={down_arrow} alt="" /></div>
                ...
                <div className="flex items-center lg:hidden MobileHeader">
                    <div id="menu" className={`relative ${headerOpen ? 'open' : ''} right-1 `} onClick={handleClick}>
                        <div id="menu-bar1" className="h-[2px] w-[29px] bg-black my-2 rounded-[20px] transition-all duration-500 ease-in-out"></div>
                        <div id="menu-bar3" className="h-[2px] w-[29px]  bg-black my-2 rounded-[20px] transition-all duration-500 ease-in-out"></div>
                    </div>
                </div>
            </div>
        </div>
